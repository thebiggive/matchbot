...
final class Version20191028145143 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE CampaignFunding (id INT UNSIGNED AUTO_INCREMENT NOT NULL, fund_id INT UNSIGNED DEFAULT NULL, amount NUMERIC(18, 2) NOT NULL, `order` INT NOT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, INDEX IDX_B00548FA25A38F89 (fund_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Donation (id INT UNSIGNED AUTO_INCREMENT NOT NULL, campaign_id INT UNSIGNED DEFAULT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', amount NUMERIC(18, 2) NOT NULL, donationStatus VARCHAR(255) NOT NULL, charityComms TINYINT(1) NOT NULL, giftAid TINYINT(1) NOT NULL, tbgComms TINYINT(1) NOT NULL, donorEmailAddress VARCHAR(255) DEFAULT NULL, donorFirstName VARCHAR(255) DEFAULT NULL, donorLastName VARCHAR(255) DEFAULT NULL, donorPostalAddress VARCHAR(255) DEFAULT NULL, donorTitle VARCHAR(255) DEFAULT NULL, salesforceLastPush DATETIME DEFAULT NULL, salesforcePushStatus VARCHAR(255) NOT NULL, salesforceId VARCHAR(18) DEFAULT NULL, salesforceLastPull DATETIME DEFAULT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, UNIQUE INDEX UNIQ_C893E3F6D17F50A6 (uuid), UNIQUE INDEX UNIQ_C893E3F6D8961D21 (salesforceId), INDEX IDX_C893E3F6F639F774 (campaign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE campaignfunding_campaign ADD CONSTRAINT FK_696E7E3484C3B9E4 FOREIGN KEY (campaignfunding_id) REFERENCES CampaignFunding (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE campaignfunding_campaign ADD CONSTRAINT FK_696E7E34F639F774 FOREIGN KEY (campaign_id) REFERENCES Campaign (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE campaignfunding_campaign DROP FOREIGN KEY FK_696E7E34F639F774');
        ...
        $this->addSql('ALTER TABLE campaignfunding_campaign DROP FOREIGN KEY FK_696E7E3484C3B9E4');
