...
/**
 * DON-1207 Drop and replace the 4 ngram search indexes
 */
final class Version20260911123329 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Drop and replace the 4 ngram search indexes';
    }
