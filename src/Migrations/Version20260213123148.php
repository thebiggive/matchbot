...
/**
 * Prepare some missed donations for new Gift Aid claim attempts, once more
 */
final class Version20260213123148 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'CLA-40 Prepare some missed donations for new Gift Aid claim attempts, once more';
    }
