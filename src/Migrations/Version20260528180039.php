...
final class Version20260528180039 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE CampaignLocation (countryName VARCHAR(50) DEFAULT NULL, regionCode VARCHAR(10) DEFAULT NULL, id INT UNSIGNED AUTO_INCREMENT NOT NULL, campaign_id INT UNSIGNED NOT NULL, INDEX IDX_6C25EDB1F639F774 (campaign_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
