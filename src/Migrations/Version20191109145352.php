 ...
 * Initial schema
 */
final class Version20191109145352 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Donation (id INT UNSIGNED AUTO_INCREMENT NOT NULL, campaign_id INT UNSIGNED DEFAULT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', transactionId VARCHAR(255) DEFAULT NULL, amount NUMERIC(18, 2) NOT NULL, donationStatus VARCHAR(255) NOT NULL, charityComms TINYINT(1) NOT NULL, giftAid TINYINT(1) NOT NULL, tbgComms TINYINT(1) NOT NULL, donorCountryCode VARCHAR(2) DEFAULT NULL, donorEmailAddress VARCHAR(255) DEFAULT NULL, donorFirstName VARCHAR(255) DEFAULT NULL, donorLastName VARCHAR(255) DEFAULT NULL, donorPostalAddress VARCHAR(255) DEFAULT NULL, donorTitle VARCHAR(255) DEFAULT NULL, salesforceLastPush DATETIME DEFAULT NULL, salesforcePushStatus VARCHAR(255) NOT NULL, salesforceId VARCHAR(18) DEFAULT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, UNIQUE INDEX UNIQ_C893E3F6C2F43114 (transactionId), UNIQUE INDEX UNIQ_C893E3F6D8961D21 (salesforceId), INDEX IDX_C893E3F6F639F774 (campaign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
