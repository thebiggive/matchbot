...
class Donation extends SalesforceWriteProxy
{
    ...
    public function createStripePaymentIntentPayload(): array
    {
        ...
        // @todo - work out details of why inferred type here doesn't match what new stripe library demands
        /**
