...
class Donation extends SalesforceWriteProxy
{
     ...
     *
     * 30 min official timed window. Grace period applied not here where it is very visible to
     * client but in setting of reservation time if requested when this is running out.
     *
     ...
     */
    public const int|float EXPIRY_SECONDS = 30 * 60;
    ...
    public function extendReservationFrom(DateTimeImmutable $at): void
    {
        ...
        $this->fundsReservedUntil = min(
            $at->modify('+5 minutes'),
            $this->maxReservationTime()->modify('+2 minutes')
        );
    }
    ...
    {
        return $this->getCreatedDateImmutable()->modify('+ ' . self::EXPIRY_SECONDS . ' seconds');
    }
}
