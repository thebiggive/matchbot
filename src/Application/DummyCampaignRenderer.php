...
//                'emailAddress' => $charity->getEmailAddress(), // not used by FE
                ...
                'logoUri' => $charity->getRawData()['logoUri'],
                'name' => $charity->getName(),
                'optInStatement' => $charity->getRawData()['optInStatement'],
                'phoneNumber' => $charity->getRawData()['phoneNumber'],
//                'postalAddress' => $charity->getPostalAddress()->format(), // not used by FE
                'regulatorNumber' => $charity->getRawData()['regulatorNumber'],
                'regulatorRegion' => $charity->getRawData()['regulatorRegion'],
                'stripeAccountId' => $charity->getRawData()['stripeAccountId'],
            ...
            'isMatched' => $campaign->getRawData()['isMatched'],
            ...
            'ready' => $campaign->getRawData()['ready'],
            'regularGivingCollectionEnd' => $campaign->getRawData()['regularGivingCollectionEnd'],
            ...
            'thankYouMessage' => $campaign->getRawData()['thankYouMessage'],
