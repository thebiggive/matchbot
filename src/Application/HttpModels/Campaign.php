 ...
 *
 * @OA\Schema(
 *   description="Charity campaign information for use in the Front End",
 * )
 */
readonly class Campaign
{
    ...
    public function __construct(
         ...
         *   @OA\Items(
         *     type="object",
         *     @OA\Property(property="uri", type="string", example="https://example.com/image1.jpg"),
         ...
         *   type="array",
         *   @OA\Items(type="string", example="Provide clean water to 1000 families")
         * )
         */
        public array $aims,
        /**
         ...
         *   type="array",
         *   @OA\Items(type="string", example="Children in rural communities")
         * )
         */
         ...
         *     @OA\Property(property="description", type="string", example="Equipment costs")
         *   )
         * )
         */
         ...
         *   type="array",
         *   @OA\Items(type="string", example="Health")
         * )
         */
         ...
         *   type="array",
         *   @OA\Items(type="string", example="United Kingdom")
         * )
         */
         ...
         *   @OA\Items(
         *     type="object",
         *     @OA\Property(property="person", type="string", example="Jane Doe"),
         *     @OA\Property(property="quote", type="string", example="This project changed my life")
         *   )
         * )
         */
        public array $quotes,
         ...
         *   @OA\Items(
         *     type="object",
         *     @OA\Property(property="content", type="string", example="We've reached 50% of our target!"),
         *     @OA\Property(property="modifiedDate", type="string", example="2025-12-02T15:30:00Z")
         *   )
         * )
         */
         ...
         *   type="object",
         *   @OA\Property(property="provider", type="string", example="youtube"),
