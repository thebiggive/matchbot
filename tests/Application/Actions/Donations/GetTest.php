...
class GetTest extends TestCase
{
    ...
    public function testNoAuth(): void
    {
        ...
        $route = $this->getRouteWithDonationId('12345678-1234-1234-1234-1234567890ab');
    ...
    public function testIdNotFound(): void
    {
        ...
        $request = $this->createRequest(
            'GET',
            '/v1/donations/87654321-1234-1234-1234-ba0987654321',
            '',
            ['x-tbg-auth' => Token::create('87654321-1234-1234-1234-ba0987654321')],
        );

        $this->expectException(HttpNotFoundException::class);
        $this->expectExceptionMessage('Donation not found');

        $route = $this->getRouteWithDonationId('87654321-1234-1234-1234-ba0987654321');
    ...
    private function getRouteWithDonationId(string $donationId): Route
    {
        $route = new Route(
            ['get'],
            '',
