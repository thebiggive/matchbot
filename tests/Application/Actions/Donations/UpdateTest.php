...
class UpdateTest extends TestCase
{
    ...
    public function testNoAuth(): void
    {
        ...
        $donationRepoProphecy
            ->findAndLockOneByUUID('12345678-1234-1234-1234-1234567890ab')
            ->shouldNotBeCalled();
        $donationRepoProphecy
    ...
    public function testIdNotFound(): void
    {
        ...
        $donationRepoProphecy = $this->prophesize(DonationRepository::class);
        $donationRepoProphecy
            ->findAndLockOneByUUID('87654321-1234-1234-1234-ba0987654321')
            ->willReturn(null)
            ->shouldBeCalledOnce();
        $donationRepoProphecy
            ->releaseMatchFunds(Argument::type(Donation::class))
    ...
    public function testMissingStatus(): void
    {
        ...
        $donationRepoProphecy = $this->prophesize(DonationRepository::class);
        $donationRepoProphecy
            ->findAndLockOneByUUID(Argument::cetera())
            ->shouldNotBeCalled();
        $donationRepoProphecy
            ->releaseMatchFunds(Argument::type(Donation::class))
            ->shouldNotBeCalled();
    ...
    public function testCancelSuccessWithNoStatusChangesIgnored(): void
    {
        ...
        $donationRepoProphecy
            ...
            ->shouldBeCalledOnce();
        // Cancel is a no-op -> no fund release
        $donationRepoProphecy
            ->releaseMatchFunds(Argument::type(Donation::class))
            ->shouldNotBeCalled();
    ...
    public function testCancelSuccessWithChangeFromPendingAnonymousDonation(): void
    {
        ...
        $donationRepoProphecy = $this->prophesize(DonationRepository::class);
        $donationRepoProphecy
            ->findAndLockOneByUUID('12345678-1234-1234-1234-1234567890ac')
            ->willReturn($responseDonation)
            ->shouldBeCalledOnce();
        $donationRepoProphecy
            ->releaseMatchFunds(Argument::type(Donation::class))
