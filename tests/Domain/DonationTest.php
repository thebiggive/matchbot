...
class DonationTest extends TestCase
{
    ...
    public function testAmountTooLowNotPersisted(): void
    {
        ...
        $this->expectExceptionMessage('Amount 0 is out of allowed range 1-25000 GBP');
    ...
    {
        $this->expectException(\UnexpectedValueException::class);
        $this->expectExceptionMessage('Amount 1 is out of allowed range 1-25000 GBP');
    ...
    {
        $this->expectException(\UnexpectedValueException::class);
        $this->expectExceptionMessage('Amount 25000 is out of allowed range 1-25000 GBP');
