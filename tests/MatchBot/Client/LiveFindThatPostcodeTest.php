...
class LiveFindThatPostcodeTest extends TestCase
{
     ...
     */
    public function testItParsesDataFromFTPCPostCodeResponse(): void
    {
        $retrievedData = json_decode(json: self::FIND_THAT_POSTCODE_SAMPLE_POSTCODE_RESPONSE, associative: true, flags: \JSON_THROW_ON_ERROR);
     ...
     * @psalm-suppress MixedArgument
     */
    public function testItParsesDataFromFTPCPointResponse(): void
    {
        $retrievedData = json_decode(json: self::FIND_THAT_POSTCODE_SAMPLE_POINT_RESPONSE, associative: true, flags: \JSON_THROW_ON_ERROR);
     ...
     * automatically.
     */
    public const string FIND_THAT_POSTCODE_SAMPLE_POSTCODE_RESPONSE = <<<'JSON'
{
  "data": {
    "attributes": {
      "bua11": "E34004707",
...
JSON;
    ...
    /**
     * @var string
     * Jason data retrieved from https://findthatpostcode.uk/points/51.501009,-0.141588.json, uneditred other than to format
     * automatically.
     */
    public const string FIND_THAT_POSTCODE_SAMPLE_POINT_RESPONSE = <<<'JSON'
{
  "data": {
    "attributes": {
      "distance_from_postcode": 1.7296266939180172
    },
    "id": [
      51.501009,
      -0.141588
    ...
    "links": {
      "html": "points/51.501009,-0.141588.html",
      "self": "points/51.501009,-0.141588"
    },
    "relationships": {
      "nearest_postcode": {
        "data": {
        ...
        "links": {
          "related": "points/51.501009,-0.141588/nearest_postcode",
          "self": "points/51.501009,-0.141588/relationships/nearest_postcode"
        }
      }
    },
    "type": "points"
