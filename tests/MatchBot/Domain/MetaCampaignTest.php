...
class MetaCampaignTest extends TestCase
{
    ...
    public function shouldBeIndexedProvider(): array
    {
        return [
            ...
            'campaign starts before INDEX_FROM 2020-01-01 (not indexed)'                        => ['2025-01-01T12:00:00z', '2019-12-31T23:59:59z', false],
            'campaign starts exactly at INDEX_FROM 2020-01-01 (> not >=, not indexed)'          => ['2025-01-01T12:00:00z', '2020-01-01T00:00:00z', false],
            'campaign starts exactly at 4 week boundary (< not <=, not indexed)'                => ['2025-01-01T12:00:00z', '2025-01-29T12:00:00z', false],
            'campaign starts just after INDEX_FROM 2020-01-01 (should be indexed)'              => ['2025-01-01T12:00:00z', '2020-01-01T00:00:01z', true],
